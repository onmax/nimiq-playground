...
<template>
  <SplitterGroup id="splitter-group" @layout="layoutH = $event" direction="horizontal" bg-neutral-0>
    <SplitterPanel id="code-pane" :default-size="layoutH?.at(0)" :min-size="20" flex="~ items-center justify-center"
      h-screen of-auto relative w-full>
    ...
    <SplitterPanel id="interactive-pane" :default-size="layoutH?.at(1)" :min-size="20">
      <SplitterGroup id="interactive-pane-group" direction="vertical" @layout="layoutV = $event">
        ...
        <SplitterResizeHandle id="handle-h-2" h-1 w-full bg-neutral-500 z-10 />
        <SplitterPanel id="terminal-pane" :default-size="layoutV?.at(2)" collapsible :collapsed-size="37" :min-size="37"
          flex="~ items-center justify-center">
          <PanelTerminal />
        </SplitterPanel>
      </SplitterGroup>
